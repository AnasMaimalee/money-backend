...
class JambPinBindingRequestPolicy
{
    /**
     * View Result file
     */
    public function view(User $user, JambPinBindingRequest $job): bool
    {
     ...
     */
    public function download(User $user, JambPinBindingRequest $job): Response
    {
     ...
     */
    public function take(User $user, JambPinBindingRequest $job): bool
    {
