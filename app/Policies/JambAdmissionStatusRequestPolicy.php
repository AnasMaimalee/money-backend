...
class JambAdmissionStatusRequestPolicy
{
    /**
     * View Result file
     */
    public function view(User $user, JambAdmissionStatusRequest $job): bool
    {
     ...
     */
    public function download(User $user, JambAdmissionStatusRequest $job): Response
    {
     ...
     */
    public function take(User $user, JambAdmissionStatusRequest $job): bool
    {
